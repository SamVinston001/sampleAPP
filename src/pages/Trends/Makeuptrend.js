        ...
        <SafeAreaView style={styles.maincontainer}>
            ...
            <View style={styles.container2}>
                ...
                <View style={styles.trendtitle}>
                    <Text style={styles.titletext}>Makeup Trends</Text>
                </View>
            </View>
            <View style={styles.container3}>
                <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                    <Image style={styles.slideimage} source={require('../../assets/images/Trendimages/makeupimage1.png')}></Image>
                    <Image style={styles.slideimage} source={require('../../assets/images/Trendimages/makeupimage2.png')}></Image>
                    <Image style={styles.slideimage} source={require('../../assets/images/Trendimages/makeupimage3.png')}></Image>
                </ScrollView>
                <AppIntroSlider
                    data={slides}
            ...
            <View style={styles.container4}>
                <Text style={styles.titletext1}>Title 1 Makeup style</Text>
            </View>
