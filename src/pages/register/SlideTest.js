...
import { SafeAreaView, Text, View,StatusBar,ScrollView, StyleSheet, ImageBackground, Image, Button, Pressable } from 'react-native';
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          <View style={{ width, height }}>
            <Image source={require('../../assets/images/intropage/logo.png')} style={styles.imageStyle} />
          ...
          <View style={{ width, height }}>
            <Image
              source={require('../../assets/images/intropage/logo.png')}
